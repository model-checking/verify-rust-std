...
- **Status:** Resolved
- **Winning Solution:** [#582](https://github.com/model-checking/verify-rust-std/pull/582)
- **Tracking Issue:** [#382](https://github.com/model-checking/verify-rust-std/issues/382)
- **Start date:** *2025/06/01*
- **Reward:** *10,000 USD*
- **Contributors:** [v3risec](https://github.com/v3risec) ([Mingzhi Gao](https://github.com/highhigh4), [Minghua Wang](https://github.com/MinghuaWang))
